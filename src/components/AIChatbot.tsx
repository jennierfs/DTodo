...
const AIChatbot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: '¡Hola! 👋 Soy tu asistente virtual de DTodo. ¿En qué puedo ayudarte hoy? Puedo mostrarte productos, comparar opciones, explicar precios y responder todas tus preguntas.',
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await fetch(
        `${envConfig.supabaseUrl}/functions/v1/ai-chatbot`,
        {
          method: 'POST',
          headers: {
      ...
      const assistantMessage: Message = {
        role: 'assistant',
        content: data.response || 'No se recibió respuesta del asistente.',
        timestamp: new Date(),
      };
      ...
      const errorMessage: Message = {
        role: 'assistant',
        content: error.message || 'Lo siento, hubo un error al procesar tu mensaje. Por favor, intenta de nuevo.',
        timestamp: new Date(),
      };
        ...
        <div className="fixed bottom-6 right-6 w-96 h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col z-50 animate-slideUp border border-gray-200">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 rounded-t-2xl flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-lg">DTodo Assistant</h3>
